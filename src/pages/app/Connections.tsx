...
import ActiveCircleCard from '../../components/threads/ActiveCircleCard';
import CollaboratorCard from '../../components/threads/CollaboratorCard';
import CommunityRoomCard from '../../components/threads/CommunityRoomCard';
import CommunityPulseStrip from '../../components/threads/CommunityPulseStrip';
import SharedThemeCluster from '../../components/threads/SharedThemeCluster';
      ...
      <div className="relative mb-10">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <motion.div 
            ...
            className="w-20 h-20 rounded-3xl bg-white/10 border border-white/80/40 flex items-center justify-center shadow-[0_0_50px_rgba(99,102,241,0.2)]"
          >
      ...
      {tabs.map((tab) => (
        <motion.button
          ...
          className={`
            ...
            ${activeTab === tab.id 
              ? 'bg-gradient-to-r from-white to-white/80 text-white shadow-lg' 
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
            <div>
              ...
              >
                ...
                <span className="text-[10px] font-bold text-white/80 uppercase tracking-[0.3em]">The Hub</span>
              </motion.div>
              <motion.h1 
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-mono text-white/80">12</p>
              </div>
              <div className="w-px h-10 bg-white/10" />
              <div className="text-center">
                    ...
                    >
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-6">
                          ...
                          <button className="text-[10px] font-bold text-white/80 uppercase tracking-wider hover:text-white/70 transition-colors">
                            View All →
                          </button>
                        </div>
                      ...
                      <div className="flex items-center justify-between mb-8">
                        <div className="relative flex-1 max-w-md">
                          ...
                          <input 
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-2xl py-3 pl-11 pr-4 text-white placeholder-gray-500 focus:outline-none focus:border-white/20 transition-all text-sm"
                            value={searchQuery}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-gradient-to-br from-white/[0.02] to-white/[0.01] border border-white/10 rounded-2xl p-6">
                          <h3 className="text-base font-bold text-white mb-5 flex items-center gap-2">
                            <TrendingUp size={18} className="text-white/80" /> Collective Intelligence
                          </h3>
                  ...
                  <div className="mt-8 space-y-4">
                    <div className="p-5 bg-white/80/5 border border-white/80/20 rounded-xl">
                      <div className="flex items-start gap-3 mb-2">
                        <Zap size={16} className="text-white/80 shrink-0 mt-0.5" />
                      ...
                      <motion.button 
                        whileHover={{ x: 3 }}
                        className="text-[10px] font-bold text-white/80 uppercase tracking-wider flex items-center gap-1 group"
                      >
