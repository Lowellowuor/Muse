        ...
        <div className="relative z-10 p-8">
          ...
          {!confirmDelete ? (
            ...
            <div className="bg-white/80/10 border border-white/80/30 rounded-2xl p-4">
              <div className="flex items-center gap-2 text-white/70 text-sm font-bold mb-3">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={handleDelete} className="flex-[2] py-2.5 rounded-xl bg-white/80 text-white text-xs font-bold uppercase tracking-widest hover:bg-white/90 transition-all cursor-pointer">
                  Yes, Delete Room
                </button>
              </div>
            </div>
